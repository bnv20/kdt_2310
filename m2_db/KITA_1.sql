...
DROP USER c##KITA CASCADE;
CREATE USER c##KITA IDENTIFIED BY KITA DEFAULT TABLESPACE users TEMPORARY TABLESPACE temp PROFILE DEFAULT;
GRANT CONNECT, RESOURCE TO c##KITA;
GRANT CREATE VIEW, CREATE SYNONYM TO c##KITA;
GRANT UNLIMITED TABLESPACE TO c##KITA;
ALTER USER c##KITA ACCOUNT UNLOCK;
